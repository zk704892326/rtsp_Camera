...
QT_MOC_LITERAL(4, 23, 5) // "index"

    },
    "FFmpeg\0GetImage\0\0image\0index"
};
...
void FFmpeg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GetImage((*reinterpret_cast< const QImage(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (FFmpeg::*_t)(const QImage & , const int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FFmpeg::GetImage)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject FFmpeg::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FFmpeg.data,
      qt_meta_data_FFmpeg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void FFmpeg::GetImage(const QImage & _t1, const int _t2)
{
