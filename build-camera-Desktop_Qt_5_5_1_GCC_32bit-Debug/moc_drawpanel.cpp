...
QT_MOC_LITERAL(1, 10, 7), // "GetRect"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 4) // "rect"

    },
    "DrawPanel\0GetRect\0\0rect"
};
...
void DrawPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GetRect((*reinterpret_cast< const QRect(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DrawPanel::*_t)(const QRect & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DrawPanel::GetRect)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DrawPanel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_DrawPanel.data,
...
// SIGNAL 0
void DrawPanel::GetRect(const QRect & _t1)
{
